...
(() => {
/*!***********************************************************!*\
  !*** ./resources/assets/js/pages/auth/change-password.js ***!
  \***********************************************************/
__webpack_require__.r(__webpack_exports__);
...
$('#form-change-password').on('submit', /*#__PURE__*/function () {
...
function handleErrors(errors) {
  ...
  $.each(errors, function (key, value) {
    console.log(key);
    console.log(value);
    $("input[name='".concat(key, "']")).after("<p class=\"validation-error\">".concat(value[0], "</p>"));
  });
}
})();
