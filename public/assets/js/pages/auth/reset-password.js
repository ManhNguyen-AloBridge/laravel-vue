...
/*!**********************************************************!*\
  ...
  \**********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_shared_loading__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../components/shared/loading */ "./resources/assets/js/components/shared/loading.js");
...
$('#form-reset').on('submit', /*#__PURE__*/function () {
...
function handleErrors(errors) {
  ...
  if (errors.messages) {
    $('.form-group-password').before("<p class=\"validation-error u-text-align-center\">".concat(errors.messages, "</p>"));
  }
  $.each(errors, function (key, value) {
    $("input[name='".concat(key, "']")).addClass('--error');
    $("input[name='".concat(key, "']")).after("<p class=\"validation-error\">".concat(value, "</p>"));
  });
}
})();
