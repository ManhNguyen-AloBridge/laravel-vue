...
/***/ "./resources/assets_new/js/components/process.js":
/*!*******************************************************!*\
  !*** ./resources/assets_new/js/components/process.js ***!
  \*******************************************************/
...
"use strict";
/*!*********************************************************!*\
  !*** ./resources/assets_new/js/pages/register/index.js ***!
  \*********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _constants_response_codes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../constants/response-codes */ "./resources/assets_new/js/constants/response-codes.js");
/* harmony import */ var _components_process__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../components/process */ "./resources/assets_new/js/components/process.js");
...
(axios__WEBPACK_IMPORTED_MODULE_2___default().defaults.headers["x-csrf-token"]) = token;
var service = axios__WEBPACK_IMPORTED_MODULE_2___default().create({
  withCredentials: true,
  timeout: 30000
});
var childPages = $('.child-page');
var userFillList = $('.form.company .confirm-group__data-item').filter('[data-user]');
var submitUserInfo = $('#user-page button[type="submit"]');
var registerButton = $('#confirm-page button[type="submit"]');
var toFixButton = $('#confirm-page button[data-step="0"]');
var checkboxConfirmTerms = $('#confirm-terms');
...
function pageInputs() {
  var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'user';
  var query = '#' + page + '-page input';
  return $(query);
}
function pageInputsData() {
  var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'user';
  var data = {};
  pageInputs(page).each(function () {
    ...
    data[inputName] = data[inputName] ? data[inputName] : $(this).prop('checked') ? inputVal : '';
  });
  return data;
}
...
function createErrorMessage(error) {
  return '<span class= "error-message text --xs color-danger">' + error[0] + '</span>';
}
function displayInputError(page, errors) {
  var first = true;
  var inputs = $("#".concat(page, "-page input"));
  inputs.each(function (index, element) {
    var name = $(element).attr('name');
    if (name in errors || "".concat(page, ".").concat(name) in errors) {
      $(element).addClass('--error');
      $(element).closest('.form__group').find('.error-message').remove();
      $(element).closest('.form__group').append(createErrorMessage(errors[name] || errors["".concat(page, ".").concat(name)]));
      if (first) {
        var _$;
        first = false;
        (_$ = $(element)) === null || _$ === void 0 ? void 0 : _$.closest('.form__group').get(0).scrollIntoView();
      }
    }
  });
}
function fillDataIfPassedValidate(data) {
  var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'user';
  var fillList = userFillList;
  var attr = 'data-user';
  fillList.each(function () {
    var input = $(this);
    var inputName = $(this).attr(attr);
...
function _nextPage() {
  _nextPage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var currentStep;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            $(childPages[currentStep]).css({
              opacity: '1'
            });
            $('#header')[0].scrollIntoView();
            process.moveToNextStep();
            _context.next = 6;
            return $(childPages[currentStep]).animate({
              opacity: '0'
            }, 800, function () {
...
function validateUserInputs() {
  return _validateUserInputs.apply(this, arguments);
}
function _validateUserInputs() {
  _validateUserInputs = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var data, errors;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            data = pageInputsData('user');
            data.isValidate = true;
            _context2.next = 5;
            return service.post('/admin/register', data, {
              headers: {
...
function _registerService() {
  _registerService = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var userData, _err$response, data, status, errorKeys, step;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            userData = pageInputsData('user');
            _context3.next = 4;
            return service.post('/admin/register', userData, {
              headers: {
                "X-Requested-With": "XMLHttpRequest"
              }
            });
          ...
          case 9:
            ...
            _components_shared_loading__WEBPACK_IMPORTED_MODULE_3__["default"].hide();
            _err$response = _context3.t0.response, data = _err$response.data, status = _err$response.status;
            if (!(status !== _constants_response_codes__WEBPACK_IMPORTED_MODULE_0__["default"].UNPROCESSABLE_ENTITY)) {
              _context3.next = 16;
              break;
            }
          ...
          case 16:
            errorKeys = Object.keys(data.errors).join('');
...
var process = new _components_process__WEBPACK_IMPORTED_MODULE_1__["default"]($('#process'));
