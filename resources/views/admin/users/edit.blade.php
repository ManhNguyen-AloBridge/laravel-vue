...
<div class="content-header pt-2 pb-1">
    <div class="container-fluid">
        <div class="d-flex align-items-end flex-wrap justify-content-between pb-2">
            <h1 class="m-0 pr-3">
                Users
                <small class="font-weight-light ml-1 text-md">Edit a user</small>
            </h1>
...
<section class="content">
    <div class="container-fluid">
        <form method="POST" action="{{ route('user.update', ['user' => $user->id]) }}" accept-charset="UTF-8" autocomplete="off">
            @method('PUT')
            @csrf
            <div class="row">
                    ...
                    <div class="card card-outline card-info">
                        ...
                        <div class="card-body pt-0">
                            <div class="form-group">
                                ...
                                @enderror
                                <input class="form-control" autofocus="" autocomplete="off" name="name" type="text" value="{{ old('name') ?? $user->name }}">
                            </div>
                            <div class="form-group">
                                <label>E-mail</label>
                                @error('email')
                                ...
                                @endif
                                <input class="form-control" autocomplete="off" name="email" type="text" value="{{ old('email') ?? $user->email }}">
